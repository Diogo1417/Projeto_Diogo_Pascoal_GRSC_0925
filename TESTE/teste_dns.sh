...
# --- PASSO 3: CONFIGURAÇÃO DOS FICHEIROS DNS (SINTAXE CORRIGIDA) ---
echo "A configurar os arquivos DNS..."

# 1. Criação do /etc/named.conf 
# CORREÇÃO: Usar a indentação rigorosa sem espaços antes do conteúdo para evitar erros.
...
# CORREÇÃO: Usar tabs (ou espaços limpos) para indentação, pois é uma zona.
...
# CORREÇÃO: Usar tabs (ou espaços limpos) para indentação.
